...
export default function ProjectsForm({ data, onChange }) {
  ...
  const addEntry = () => {
    ...
    onChange([
      ...data,
      { id: newId, name: '', role: '', url: '', startDate: '', endDate: '', bullets: [''] },
    ]);
  };
          ...
          <div key={entry.id} className="p-4 bg-slate-50 rounded-lg border border-slate-200">
            ...
            <div className="mb-3 mt-0">
              <InputField
                ...
                value={entry.url}
                onChange={(v) => updateEntry(entry.id, 'url', v)}
                ...
                {entry.bullets.map((bullet, idx) => (
                  <div key={idx} className="flex gap-2 items-start">
                    ...
                    <button
                      ...
                      className="mt-2 text-slate-300 hover:text-red-400 transition-colors flex-shrink-0"
                    >
                      <svg
                        className="w-4 h-4"
                        fill="none"
